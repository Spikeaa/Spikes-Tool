...
#all the metadata code not actually used in current version.
#was used for a previous metadata analysis implementation,
#but it can be left here for further development.
